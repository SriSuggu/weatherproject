   function weather()
   {
	   ...
	   var result=[];
	   $("#latlong").ready(function() {
	   	  var loc1= document.getElementById('lat').value;
	      ...
	      var date1 = document.getElementById('datevalue').value;
	        ...
	        var apiurl = "http://apidev.accuweather.com/locations/v1/search?q="+loc1+"&apikey=hoArfRosT1215";
	   	 	 $.ajaxSetup({
	   	         async: false
	   	     });
		 	 ...
		 	 $.ajaxSetup({
		 	   ...
		 	   for(var i=0;i<=7;i++)
			 	...
			 	console.log(date);
			 	datearr.push(date);
			 	var apiurl = "https://api.darksky.net/forecast/3476ac5af82da1f43aa6e9b8fd29d0b4/"+result[0]+","+result[1]+","+date+"T12:00:00";
